...
For my presentation i am using:-
Company type: B2B SaaS
Employees: ~7,000
History window: Last 6 months
Departments using Asana: Engineering,Marketing,Operations.

This project generates a realistic synthetic dataset representing how a large B2B SaaS organization (5,000–10,000 employees) uses Asana for engineering, marketing, and operations workflows. The primary objective is to create enterprise-grade seed data suitable for reinforcement learning environments, enabling meaningful evaluation of AI agents interacting with project management systems.
